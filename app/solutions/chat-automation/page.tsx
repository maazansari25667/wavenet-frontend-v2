      ...
      <section className="py-20 px-6">
        <div className="mx-auto max-w-4xl text-center">
          <span className="rounded-full border border-primary/40 bg-primary/10 backdrop-blur-sm px-6 py-2 text-sm font-medium text-primary">
            {t("solutions.chatAutomation.badge")}
          </span>
          <h1 className="mt-8 text-5xl md:text-6xl font-bold text-foreground text-balance">
            {t("solutions.chatAutomation.title")}
          </h1>
          <p className="mt-6 text-xl text-muted-foreground text-balance">{t("solutions.chatAutomation.subtitle")}</p>
          <Button asChild size="lg" className="mt-8">
            <Link href="/contact">{t("solutions.chatAutomation.cta")}</Link>
          </Button>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="rounded-2xl border border-border/40 bg-card/70 backdrop-blur-lg p-8 shadow-xl">
              ...
              <h3 className="text-2xl font-bold text-foreground mb-4">
                {t("solutions.chatAutomation.feature1.title")}
              </h3>
              <p className="text-muted-foreground leading-relaxed">{t("solutions.chatAutomation.feature1.desc")}</p>
            </div>
            ...
            <div className="rounded-2xl border border-border/40 bg-card/70 backdrop-blur-lg p-8 shadow-xl">
              ...
              <h3 className="text-2xl font-bold text-foreground mb-4">
                {t("solutions.chatAutomation.feature2.title")}
              </h3>
              <p className="text-muted-foreground leading-relaxed">{t("solutions.chatAutomation.feature2.desc")}</p>
            </div>
            ...
            <div className="rounded-2xl border border-border/40 bg-card/70 backdrop-blur-lg p-8 shadow-xl">
              ...
              <h3 className="text-2xl font-bold text-foreground mb-4">
                {t("solutions.chatAutomation.feature3.title")}
              </h3>
              <p className="text-muted-foreground leading-relaxed">{t("solutions.chatAutomation.feature3.desc")}</p>
            </div>
          </div>
        </div>
      </section>
