...
export default function ResellerBenefitsPage() {
  const { t } = useLanguage()

  const benefits = [
    {
      title: t("reseller.benefits.payout.title"),
      description: t("reseller.benefits.payout.desc"),
    },
    {
      title: t("reseller.benefits.operations.title"),
      description: t("reseller.benefits.operations.desc"),
    },
    {
      title: t("reseller.benefits.payment.title"),
      description: t("reseller.benefits.payment.desc"),
    },
    {
      title: t("reseller.benefits.bonus.title"),
      description: t("reseller.benefits.bonus.desc"),
    },
    {
      title: t("reseller.benefits.pricing.title"),
      description: t("reseller.benefits.pricing.desc"),
    },
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50/30 via-purple-50/20 to-white">
        ...
        <div className="mx-auto max-w-4xl text-center">
          <div className="mb-6">
            <span className="rounded-full border border-primary/40 bg-primary/10 backdrop-blur-sm px-6 py-2 text-sm font-medium text-primary">
              {t("reseller.benefits.badge")}
            </span>
          </div>
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-foreground mb-6 text-balance">
            {t("reseller.benefits.title")}
          </h1>
          <p className="text-lg md:text-xl text-muted-foreground mb-8 text-balance">
            {t("reseller.benefits.subtitle")}
          </p>
        </div>
      </section>
      ...
      <section className="py-16 px-6">
        <div className="mx-auto max-w-5xl space-y-8">
          {benefits.map((benefit, index) => (
            <div
              key={index}
              className="rounded-2xl border border-border/40 bg-card/70 backdrop-blur-lg p-8 shadow-xl hover:shadow-2xl transition-all"
            >
      ...
      {/* Summary Section */}
      <section className="py-16 px-6 bg-gradient-to-br from-primary/5 to-purple-50/30">
        <div className="mx-auto max-w-4xl text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-6">
            {t("reseller.benefits.summary.title")}
          </h2>
          <p className="text-lg md:text-xl text-muted-foreground mb-8 leading-relaxed">
            {t("reseller.benefits.summary.desc")}
          </p>
          <Button asChild size="lg" className="shadow-lg">
            <Link href="/contact">{t("reseller.benefits.cta")}</Link>
          </Button>
        </div>
      </section>
    </div>
